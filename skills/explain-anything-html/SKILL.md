...
- Don't use ASCII diagrams. Always use simple HTML designs for your diagrams, HTML lists for lists of things, etc.
  - For code blocks, equations, or any preformatted text, always use `<pre>` tags. If you use a custom styled div instead, it **must** have
...
_Adapted from `explain-diff-html`, which is based on Geoffrey Litt's original skill: https://gist.github.com/geoffreylitt/a29df1b5f9865506e8952488eac3d524_
