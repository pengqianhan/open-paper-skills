...
| [humanizer](humanizer/) | Rewrite AI-sounding text so it reads naturally, using 35 Wikipedia "Signs of AI writing" patterns, without changing what it says. | [blader/humanizer](https://github.com/blader/humanizer), MIT |
